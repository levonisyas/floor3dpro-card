...
## Built on a Real Game-Engine Backbone `Release` *1.5.3-Pro.Faz.0*
...
---
## Additional PRO Features `Release` *1.5.3-Pro.Faz.1*
...
A parallelepiped is drawn to highlight the room. Works with all room objects whose names contain “room.” Non‑rectangular rooms are simplified. Supports colorcondition.
...
|---------------|-------------|
| State | Defines the entity state that hides the object. |
...
|---------------|-------------|
| State | Defines the entity state that shows the object. |
