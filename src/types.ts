...
export type ProSkill = 'level' | 'editor' | 'mobile' | 'all';
export type ProSkillConfig = ProSkill | ProSkill[];

export type ProLog = 'engine' | 'all';
export type ProLogConfig = ProLog | ProLog[];
